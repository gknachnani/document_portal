...
class DocumentIngestion:
    ...
    def save_uploaded_files(self, reference_file, actual_file):
        """
        Saves reference and actual PFDF files in the session directory.
        """
        try:
            ...
            self.log.error("Error saving PDF fles", error=str(e), session=self.session_id)
    ...
    def combine_documents(self)->str:
        """
        Combines content of all PDFs in session folder into a single string.
        """
        try:
            doc_parts = []
