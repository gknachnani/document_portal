...
class SingleDocIngestor:
    def __init__(self, data_dir: str = "data/single_document_chat", faiss_dir: str = "faiss_index"):
        ...
        try:
            ...
            raise DocumentPortalException("Initialization error in SingleDocIngestor",sys) from e
    ...
    def ingest_files(self, uploaded_files):
        try:
            ...
            for uploaded_file in uploaded_files:
                unique_filename = f"session_{datetime.now(timezone.utc).strftime('%Y%m_%H%M%S')}_{uuid.uuid4().hex[:8]}.pdf"
            ...
            raise DocumentPortalException("Error during file ingestion",sys) from e
    ...
    def _create_retriever(self,documents):
        try:
            ...
            raise DocumentPortalException("Error during FAISS retriever",sys) from e
