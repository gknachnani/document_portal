...
class ConvesationalRAG:
    def __init__(self, session_id:str, retriever=None):
        try:
            ...
            if retriever is None:
                raise ValueError("Reriever cannot be None")
            ...
            raise DocumentPortalException("Initialization error in ConversationalRAG",sys) from e
    ...
    def load_retriever_from_faiss(self, index_path:str):
        ...
        try:
            ...
            if not os.path.isdur(index_path):
            ...
            raise DocumentPortalException("Loading error in ConversationalRAG",sys) from e
    ...
    def invoke(self, user_input:str, chat_history: Optional[List[BaseMessage]] = None) ->str:
        ...
        try:
            ...
            self.log.info("Chain invoked successfully", 
                ...
                answer_previw=answer[:150],
            )
            return answer
        except Exception as e:
            self.log.error("Failed to invoke ConversationalRAG",error=str(e))
            raise DocumentPortalException("Invocation error in ConversationalRAG",sys) from e
    ...
    def _load_llm(self):
        try:
            ...
            raise DocumentPortalException("LLM Loading error in ConversationalRAG",sys) from e
    ...
    def _build_lcel_chain(self):
        try:
            ...
            raise DocumentPortalException("Chain building error in ConversationalRAG",sys) from e
